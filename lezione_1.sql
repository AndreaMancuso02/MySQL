...
('Marco', 'Rossi', 'm', 'Via Alberto 5', 'Torino', 'mr@gmail.com', '1983-01-01'),
('Bruno', 'Bianchi', 'm', 'Via Garibaldi 30', 'Torino', 'bb@gmail.com', '1985-01-01');

insert into studenti(cognome, email)values('vecchio', 'vcc@gmial.com');

insert into studenti(cognome, email, genere)values('Verdi', 'vd@gmial.com', 'm');

insert into studenti
values(default, 'Marco', 'Rossi', 'm', 'Via Milano 30', 'Torino', default, default, 'mrss@gmail.com', '1980-01-01', default, default);
...
update studenti
set genere = 'm', indirizzo = 'Via pippo 5', citta = 'Torino', data_nascita = '1980-10-05'
where id = 10;
